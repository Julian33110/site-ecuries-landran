...
async function submitOrder() {
  ...
  try {
    ...
    const paymentBlockHtml =
      data.paymentMethod === 'iban'
        ? `<p>Réglez par virement bancaire à :</p>
           <div class="cart-confirmation-iban">
             <strong>${esc(data.iban)}</strong>
           </div>`
    ...
    document.getElementById('cartConfirmation').innerHTML = `
      ...
      <p>Un email de confirmation vient de vous être envoyé. Vos photos vous seront transmises par WeTransfer une fois le paiement reçu.</p>
